 ...
 *
 * JPAQueryFactory는 QuerydslConfig가 등록한 빈을 주입받는다. fragment(*Impl)는 Spring Data가 규칙으로 결합하므로 @Repository가 불필요하다.
 * repository slice 테스트가 필요해지면 @TestConfiguration으로 JPAQueryFactory 빈만 등록하면 된다.
 */
